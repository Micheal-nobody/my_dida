...
import 'calendar_widgets/calendar_habit_without_time.dart';
import 'calendar_widgets/calendar_task_without_time.dart';
...
class _CalendarAllDayTaskSectionState extends State<CalendarAllDayTaskSection> {
  ...
  Widget build(
    ...
    builder: (context, checklistProvider, taskProvider, child) => DragTarget<Task>(
      onMove: (details) {
        // 跟踪拖拽位置
      ...
      onAcceptWithDetails: (details) async {
        ...
        if (_lastDragPosition != null) {
          ...
          await taskProvider.updateStartTime(task, newTime, isAllDay: true);
        }
      },
