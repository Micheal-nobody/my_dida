...
class _AddTaskDialogState extends State<AddTaskDialog> {
  ...
  void initState() {
    ...
    if (widget.presetTask != null) {
      ...
      _dateTimePickerValue = CustomDateTimePickerValue(
        ...
        startTime: taskStart != null && !taskStart.justDate() ? TimeOfDay.fromDateTime(taskStart) : null,
        endTime: taskEnd != null && !taskEnd.justDate() ? TimeOfDay.fromDateTime(taskEnd) : null,
  ...
  String _getDateDisplayText() {
    ...
    if (!_dateTimePickerValue.isAllDay && _dateTimePickerValue.startTime != null) {
      final startStr = '${_dateTimePickerValue.startTime!.hour.toString().padLeft(2, '0')}:${_dateTimePickerValue.startTime!.minute.toString().padLeft(2, '0')}';
      if (_dateTimePickerValue.endTime != null) {
        final endStr = '${_dateTimePickerValue.endTime!.hour.toString().padLeft(2, '0')}:${_dateTimePickerValue.endTime!.minute.toString().padLeft(2, '0')}';
  ...
  Task _buildTaskFromForm({
    ...
    final date = _dateTimePickerValue.startDate ?? _dateTimePickerValue.selectedDate;
    if (date != null) {
      if (_dateTimePickerValue.isAllDay || _dateTimePickerValue.startTime == null) {
    ...
    final endDate = _dateTimePickerValue.endDate ?? _dateTimePickerValue.selectedDate;
    if (endDate != null && _dateTimePickerValue.endTime != null && !_dateTimePickerValue.isAllDay) {
      finalEnd = DateTime(
        endDate.year,
        endDate.month,
        endDate.day,
      ...
      if (index != null) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (mounted && index + 1 < _checkpointFocusNodes.length) {
            FocusScope.of(context).requestFocus(_checkpointFocusNodes[index + 1]);
          }
        });
      } else {
        ...
        children: [
          if (hasRepeat)
            InputChip(
              ...
              onDeleted: () {
                setState(() {
                  _dateTimePickerValue = _dateTimePickerValue.copyWith(rrule: null);
                });
              },
                      ...
                      children: [
                        TextButton.icon(
                          ...
                          icon: Icon(
                            ...
                            size: 18,
                            color: _dateTimePickerValue.selectedDate != null ? Colors.orange : Colors.grey[600],
                          ),
                          label: Text(
                            _getDateDisplayText(),
                            style: TextStyle(
                            ...
                            builder: (context, provider, child) {
                              ...
                              return PopupMenuButton<ChecklistVO>(
                                ...
                                itemBuilder: (context) => provider.allCheckLists
                                    .map((checklist) => PopupMenuItem<ChecklistVO>(
                                          value: checklist,
                                          child: Row(
                                            children: [
                                              Icon(Icons.folder, color: checklist.color, size: 18),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Icon(
                                        Icons.folder_open,
                                        size: 20,
                                        color: _selectedChecklist != null ? Colors.orange : Colors.grey[600],
                                      ),
                                      if (_selectedChecklist != null) ...[
                                        const SizedBox(width: 4),
                                        Text(
            ...
            children: [
              ...
              IconButton(
                icon: Icon(
                  ...
                  color: _checkpoints.isNotEmpty ? Colors.orange : Colors.grey[600],
                ),
              ...
              IconButton(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('附件功能暂未集成')),
                  );
                },
                tooltip: '添加附件',
              ),
