...
class _HabitVisibleRangeDialogState extends State<HabitVisibleRangeDialog> {
  ...
  @override
  Widget build(BuildContext context) => BaseBottomSheetLayout(
    title: '显示范围',
    onReset: () {
      setState(() {
    ...
    child: Column(
      ...
      children: [
        const Text('打卡状态', style: TextStyle(fontSize: 14, color: Colors.grey)),
        ...
        const Text('提醒时段', style: TextStyle(fontSize: 14, color: Colors.grey)),
        const SizedBox(height: 8),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
          children: [
        ...
        const SizedBox(height: 16),
        const Text('习惯频次', style: TextStyle(fontSize: 14, color: Colors.grey)),
        const SizedBox(height: 8),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
          children: [
