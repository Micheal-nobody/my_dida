...
class AddTaskFullScreenContent extends StatelessWidget {
  ...
  Widget _buildTimeDisplayRow(BuildContext context, AddTaskBottomSheetState state) => InkWell(
          ...
          child: Row(
            children: [
              ...
              if (state.dateTimePickerValue.selectedDate != null)
                IconButton(
                  icon: Icon(Icons.clear, size: 18, color: context.theme.unselectedLabelColor),
                  onPressed: state.clearDateTimePicker,
                )
              else
                Icon(Icons.chevron_right, color: context.theme.unselectedLabelColor, size: 20),
            ],
          ),
        ),
      );

  Widget _buildTextFields(BuildContext context, AddTaskBottomSheetState state) => Padding(
        ...
        child: Column(
          ...
          children: [
            TextField(
              ...
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: context.theme.textPrimary),
  ...
  Widget _buildFullScreenCheckpointsSection(BuildContext context, AddTaskBottomSheetState state) {
  ...
  Widget _buildFullScreenBottomBar(BuildContext context, AddTaskBottomSheetState state) => Container(
        ...
        child: Row(
          ...
          children: [
            Row(
              children: [
                IconButton(
                  icon: Icon(
                    Icons.label_outline,
                    color: state.tags.isNotEmpty ? context.theme.iconColor : context.theme.unselectedLabelColor,
                  ),
                ...
                IconButton(
                  icon: Icon(
                    ...
                    color: state.checkpoints.isNotEmpty ? context.theme.iconColor : context.theme.unselectedLabelColor,
                  ),
                  onPressed: state.addCheckpoint,
                  tooltip: '添加检查点',
                ),
                IconButton(
                  icon: Icon(Icons.attach_file, color: context.theme.unselectedLabelColor),
                  onPressed: () {
            ...
            IconButton(
              icon: Icon(Icons.fullscreen_exit, color: context.theme.unselectedLabelColor),
